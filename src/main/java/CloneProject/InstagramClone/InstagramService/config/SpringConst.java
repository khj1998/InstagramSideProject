...
public class SpringConst {
    ...
    public static final String[] PERMITTED_URIS = {"/users/register","/login/failure","/access-token/re-allocation","/users/logout","/login/success","/api/authorization/service"};
